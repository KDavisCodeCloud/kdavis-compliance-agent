...
kdavis-agentic-platform/core/db.py and kdavis-finops-agent/core/db.py
(proven necessary against the same class of Postgres pooler) -- pass this
as create_pool's init=.
"""
